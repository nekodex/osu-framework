...
namespace osu.Framework.Tests.Visual.Audio
{
    public class TestSceneAudioMixerNested : FrameworkTestScene
    {
        ...
        {
            AddStep("fuk", () => { });
            AddStep("set Mixer to parentMixer", () =>
            {
                // parentMixer.Add(subMixer);
                subMixer.Mixer = parentMixer;
            });
            AddStep("set Mixer to GlobalMixer", () =>
            {
                // audio.GlobalMixer.Add(subMixer);
                subMixer.Mixer = audio.GlobalMixer;
            });
            AddStep("set Mixer to null", () =>
            {
                // subMixer.Mixer?.Remove(subMixer);
                subMixer.Mixer = null;
            });
        }
